...
`
	...
	want := strings.ReplaceAll(raw, `config_version = 7`, `config_version = 9`)
...
`
	...
	if parsed.ConfigVersion != 9 || len(parsed.Providers) != 1 || parsed.Providers[0].Kind != "openai" || *parsed.Providers[0].WebSearch {
